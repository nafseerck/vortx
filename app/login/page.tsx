...
export const metadata: Metadata = {
  title: "Investor Access Required — BLSTX Dry Ice",
  description: "Private Investor Presentation for BLSTX Dry Ice Dubai. Password required for financial models & CAPEX.",
        ...
        <div className="rounded-3xl border border-cyan-400/20 bg-[#081b22]/90 p-8 backdrop-blur-2xl shadow-2xl shadow-cyan-950/50 sm:p-10">
          <div className="mb-8 text-center flex flex-col items-center">
            ...
            <p className="mt-2 text-xs leading-relaxed text-white/60 text-pretty">
              Choose between confidential Investor Presentation or public Customer Services.
            </p>
          </div>
