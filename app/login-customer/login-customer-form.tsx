...
function SubmitButton() {
  ...
  return (
    ...
    >
      ...
      {pending ? "Authenticating…" : "Unlock Customer Site"}
    </button>
  )
}

export function CustomerLoginForm() {
  const [state, formAction] = useActionState(loginCustomer, undefined)
    ...
    <div className="space-y-6">
      <form action={formAction} className="space-y-4">
        ...
        <div>
          ...
          >
            <span>Customer Site Password</span>
          </label>
          <input
            id="password"
            name="password"
            ...
            placeholder="Enter customer site password"
      ...
      <div className="relative border-t border-white/10 pt-6 text-center">
        ...
        <div className="rounded-xl border border-cyan-400/30 bg-cyan-950/30 p-4 text-left backdrop-blur">
          ...
          <p className="mt-1 text-xs text-white/60">
            Access confidential financial models, unit economics, and CAPEX breakdown.
          </p>
          <a
            href="/login"
          ...
          >
            <span>Go to Investor Login</span>
