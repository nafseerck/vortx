  ...
  return (
    <section id="summary" className="relative mx-auto max-w-6xl px-5 py-24 sm:px-8 sm:py-32">
      <SectionHeading
        ...
        description="BLASTX addresses the urgent UAE demand for specialized, zero-water, chemical-free precision cleaning — combining high-ticket automotive preservation with scalable commercial B2B maintenance contracts."
      />
